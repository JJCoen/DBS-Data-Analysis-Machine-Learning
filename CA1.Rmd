...
rules and instances. Evaluation measures are squared error, absolute error and bias error.   Gradient descent is one optimization technique.
...
concise form. Representations include graphical models and support vector
machines. The confusion matrix or ROC curve are evaluation measures for a
binary classifier.  Optimization methods are SVM loss and Entropy loss.
